...
from sklearn.metrics import max_error, mean_squared_error, mean_absolute_percentage_error
from sklearn.neighbors import KNeighborsRegressor
from sklearn.neural_network import MLPRegressor
from sklearn import tree
import matplotlib.pyplot as plt 

data = np.array(pd.read_csv('DatosKernel.csv'))
...
#------------ Redes neuronales -------------------------
regresor_n = MLPRegressor(hidden_layer_sizes = (100,3), activation = 'tanh')
...
print('Procenta medio de error : ',mean_absolute_percentage_error(y_pred1n,y_test))
print('MSE: ',mean_squared_error(y_pred1n,y_test))
