...
svd = np.array(pd.read_csv('descomposicionSVD.csv'))
...
svd = scaler.fit_transform(svd)

#------------------- PCA ------------------------------------

print('------------- PCA------------------------')

x_train,x_rest, y_train, y_rest = train_test_split(pca,Price, test_size=0.4)
...
#-------- Validar -------------------------
y_pred1 = regresor_n.predict(x_train)
print('Error maximo : ',max_error(y_pred1n,y_train))
print('Procenta medio de error : ',mean_absolute_percentage_error(y_pred1n,y_train))
...
#
#print('------------- SVD ------------------------')
#x_train,x_rest, y_train, y_rest = train_test_split(svd ,Price, test_size=0.4)
#x_val, x_test, y_val, y_test = train_test_split(x_rest,y_rest, test_size = 0.5)
#
##------------ Regression lineal -------------------------
##--------Entrenar ------------------------
...
#
##------------ Redes neuronales -------------------------
#regresor_n = MLPRegressor(hidden_layer_sizes = (3,9), activation = 'tanh')
#regresor_n.fit(x_train, y_train)
##-------- Validar -------------------------
...
#
###------------ Decesion tree  -------------------------
#regressor = tree.DecisionTreeRegressor(max_depth = 15)
#regressor.fit(x_train, y_train)
##-------- Validar -------------------------
##y_pred1 = regressor.predict(x_val)
##print('Error maximo : ',max_error(y_pred1,y_val))
